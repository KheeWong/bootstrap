...
class Toast {
  ...
  _positionToast() {
    ...
    if (this._config.position.indexOf('top-') > -1) {
      ...
      if (this._config.position === PositionMap.TOP_RIGHT) {
        ...
        this._element.classList.add(ClassName.TOP_CENTER)
    ...
    if (this._config.position.indexOf('bottom-') > -1) {
      ...
      if (this._config.position === PositionMap.BOTTOM_RIGHT) {
        ...
        this._element.classList.add(ClassName.BOTTOM_CENTER)
        this._element.style.left = `${leftPx}px`
      }
  ...
  _clearPositioning() {
    ...
    this._element.classList.remove(ClassName.TOP_CENTER)
    this._element.classList.remove(ClassName.BOTTOM_LEFT)
    this._element.classList.remove(ClassName.BOTTOM_RIGHT)
    this._element.classList.remove(ClassName.BOTTOM_CENTER)
  }
